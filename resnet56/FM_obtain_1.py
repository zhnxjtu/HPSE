...
if __name__ == '__main__':
    for num_fig in range(1, 501):
        ...
        for layer_num in range(1,19):

            if layer_num == 1:

                pretrained_dict = torch.load('../2.Pre-trained_Model/resnet56_ori.pth')  # change
        ...
        #
        # layer_num = 18
        # pretrained_dict = torch.load('../res56/Res56_test_199.pth')  # change
        #
        # model_dict = model.state_dict()
        # model_dict.update(pretrained_dict)
        # model.load_state_dict(model_dict)
        ...
        #             break
        #
        #     for index, layer in model.module.layer1[8]._modules.items():
        #         x = layer(x)
        #         if index == 'conv2':
        #             # print(index)
        #             break
