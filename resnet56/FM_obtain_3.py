...
if __name__ == '__main__':
    for num_fig in range(1, 501):
        ...
        k = 0
        index_dic = [0, 1, 2, 3, 4, 5, 6, 7]

        for layer_num in range(37, 55):
            ...
            if layer_num == 37:
                ...
                with torch.no_grad():
                    ...
                    for index, layer in model.module.layer3[0]._modules.items():
                        x = layer(x)
                        if index == 'conv1':
                            print(index)
                            break
            ...
            if layer_num > 38:
                ...
                with torch.no_grad():
                    ...
                    for index, layer in model.module.layer3._modules.items():
                        x = layer(x)
                        if index == str(index_dic[k]):
                            print('--- {}\t'.format(index), end='')
                            break

                    for index, layer in model.module.layer3[index_dic[k] + 1]._modules.items():
                        x = layer(x)
                        if index == index_conv:
        ...
        #
        # layer_num = 54
        # pretrained_dict = torch.load('./model-18/res56_71.pth')  # change
        #
        ...
        #             break
        #
        #     for index, layer in model.module.layer3[8]._modules.items():
        #         x = layer(x)
        #         if index == 'conv2':
        #             print(index)
        #             break
