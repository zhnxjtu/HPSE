...
def main():
    ...
    pretrained_dict = torch.load('../2.Pre-trained_Model/resnet56_ori.pth')
    ...
    layer_prune = [6, 8, 12, 14, 18, 20, 24, 26, 30, 32, 36, 38, 42, 44, 48, 50, 54, 56,
                   61, 63, 67, 69, 73, 75, 79, 81, 85, 87, 91, 93, 97, 99, 103, 105, 109, 111,
                   116, 118, 122, 124, 128, 130, 134, 136, 140, 142, 146, 148, 152, 154, 158, 160, 164, 166]
    indices_pruned = {}
...
############################################################################################################################
    file_name = open('./res56_acc-' + str(num_prune) + '.txt', mode='w')
...
def load_pruning_file(layer_num):
    ...
    # f = open('./4.Pruned_Label/pruned_label_res56_0.53/FM' + str(layer_num) + '.txt', 'r')
