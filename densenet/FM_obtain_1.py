        ...
        for layer_num in range(1,13):
            ...
            if layer_num == 1:
                ...
                with torch.no_grad():
                    ...
                    for index, layer in model.module.block1.layer[0]._modules.items():
                        x = layer(x)
                        if index == 'conv1':
                            print(index)
                            break
            ...
            if layer_num > 1:
                ...
                with torch.no_grad():
                    ...
                    for index, layer in model.module.block1.layer._modules.items():
                        x = layer(x)
                        if index == str(index_dic[k]):
                            print('--- {}\t'.format(index), end='')
                            break

                    for index, layer in model.module.block1.layer[index_dic[k] + 1]._modules.items():
                        x = layer(x)
                        if index == 'conv1':
