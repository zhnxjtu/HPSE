...
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for clu_col = 1:size(index_cluster,2)  
        index_cluster_final(clu_col) = mode(index_cluster(:,clu_col));
    end
    ...
    pruned_label = [];
    for i = 1:k
        eval(['par(i)= length(pruned_label' num2str(i) ')/num_of_filter;']);
        eval(['pruned_label = [pruned_label;pruned_label' num2str(i) '(1:floor(par(i)*removed_num))];']);
    end
